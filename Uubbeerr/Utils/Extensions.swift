...
extension UIView{
    func inputContainerView(image: UIImage, textField: UITextField? = nil, segementControl: UISegmentedControl? = nil) -> UIView {
        ...
        separateView.anchor(left:view.leftAnchor, bottom: view.bottomAnchor,
